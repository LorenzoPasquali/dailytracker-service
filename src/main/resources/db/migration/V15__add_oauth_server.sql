-- Spring Authorization Server JDBC schema (OAuth 2.1 for the MCP endpoint).
-- Adapted from the SAS reference schema for PostgreSQL: blob -> text, timestamp -> timestamptz.
...
-- Look up a user's granted apps for the "authorized apps" management UI.
